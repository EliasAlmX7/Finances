...
import { Settings as SettingsIcon, Trash2, AlertTriangle, Moon, Sun, BellRing } from 'lucide-react';
        ...
        <Card className="p-8 bg-card border border-border rounded-[32px] premium-shadow flex flex-col gap-6">
          <div className="flex items-center gap-4 border-b border-border/50 pb-6">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-sm text-muted-foreground">Resetar banco de dados local</span>
            </div>
          </div>
